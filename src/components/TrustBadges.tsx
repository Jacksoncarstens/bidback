// COMPONENT: Trust badge strip for footer
const BADGES = [
  {
    icon: (
  ...
  },
  {
    ...
    label: 'Trusted by Contractors Nationwide',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <div className="py-8 px-4 border-t border-gray-800">
      <div className="max-w-4xl mx-auto flex flex-wrap justify-center items-center gap-x-8 gap-y-4">
        {BADGES.map(b => (
          <div key={b.label} className="flex items-center gap-2 text-gray-500 hover:text-gray-300 transition-colors">
